        ...
        <TabPane tabId="1">
          <Row>
            <div className="container">
              ...
              <div className="col-md-3">
              <Card>
              <CardImg top width="100%" src="https://ld-wp.template-help.com/woocommerce_prod-18520/v2/wp-content/uploads/2018/08/Striped-Patchwork-Dress_1.jpg" alt="Card image cap" />
              <CardBody>
